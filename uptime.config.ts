const pageConfig = {
  ...
  links: [
    ...
    { link: 'https://blog.vekixx.com/', label: 'Blog' },
  ],
  // [可选] 对监控进行分组
  // 如果不指定，所有监控将显示在一个列表中
...
const workerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: 'Blog',
      method: 'HEAD',
      target: 'https://blog.vekixx.com/',
      statusPageLink: 'https://blog.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Guide',
      method: 'HEAD',
      target: 'https://guide.vekixx.com/',
      statusPageLink: 'https://guide.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Openlist',
      method: 'HEAD',
      target: 'https://olist.vekixx.com/',
      statusPageLink: 'https://olist.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'ImageHost',
      method: 'HEAD',
      target: 'https://c.vekixx.com/',
      statusPageLink: 'https://c.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Paste Server',
      method: 'HEAD',
      target: 'https://paste.vekixx.com/',
      statusPageLink: 'https://paste.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Nextcloud',
      method: 'GET',
      target: 'https://n.vekixx.com/',
      statusPageLink: 'https://n.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Waline',
      method: 'HEAD',
      target: 'https://waline.vekixx.com/',
      statusPageLink: 'https://waline.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Wallos',
      method: 'HEAD',
      target: 'https://w.vekixx.com/',
      statusPageLink: 'https://w.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      name: 'RandomimageAPI',
      method: 'HEAD',
      target: 'https://rd.vekixx.com/',
      statusPageLink: 'https://rd.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '1Panel',
      method: 'HEAD',
      target: 'https://1p.vekixx.com/',
      statusPageLink: 'https://1p.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'ITTools',
      method: 'HEAD',
      target: 'https://tool.vekixx.com/',
      statusPageLink: 'https://tool.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      method: 'HEAD',
      target: 'https://d.vekixx.com/',
      statusPageLink: 'https://d.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'FileTransfer',
      method: 'HEAD',
      target: 'https://share.vekixx.com/',
      statusPageLink: 'https://share.vekixx.com/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: 'Yourls',
      method: 'HEAD',
      target: 'https://vekixx.com/admin/',
      statusPageLink: 'https://vekixx.com/admin/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
